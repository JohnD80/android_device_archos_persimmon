...
git apply -v --check ../../device/archos/persimmon/patches/framework_base/0002-mt6735_2.patch
cd ../..
...
git apply -v --check ../../../device/archos/persimmon/patches/packages_apps_Bluetooth/0001-mt6735.patch
cd ../../..
cd external/bluetooth/bluedroid/
git apply -v --check ../../../device/archos/persimmon/patches/bluedroid/0001-mt6735.patch
cd ../../..
